...
var ={'Min_count_for_sale_Гб':5, 'Min_count_for_sale_минуты':100, 'Максимальное_увеличение_количества_на_продажу':0,
      ...
      "Телефоны":{
          '9019861431': {'Активная_симка': True, 'Name': 'Дима', 'Оставлять_минуты': 190, 'Оставлять_Гб': 19, 'День_обновления_остатков': 12, 'Абонплата': 300, 'Описание': 'Ярославль  40 ГБ, 800 минут'},
      ...
      '9005093361': {'Активная_симка': True, 'Name': 'Александр', 'Оставлять_минуты': 100, 'Оставлять_Гб': 1, 'День_обновления_остатков': 12, 'Абонплата': 500, 'Описание': 'Вологда 35 ГБ, 700 минут', 'ЛС': '9535248000'},
      '9005424360': {'Активная_симка': True, 'Name': 'Александр', 'Оставлять_минуты': 0, 'Оставлять_Гб': 0, 'День_обновления_остатков': 12, 'Абонплата': 250, 'Описание': '!!! поменять Вологда 5 ГБ, 200 минут', 'ЛС': '9535248000'},
      '9535248000': {'Активная_симка': True, 'Name': 'Александр', 'Оставлять_минуты': 600, 'Оставлять_Гб': 14, 'День_обновления_остатков': 17, 'Абонплата': 400, 'Описание': 'Вологда 25ГБ, 600 минут', 'ЛС': '9535248000'},
      ...
      '9011720400':{'Активная_симка':False, 'Name':'Надежда личный', 'Оставлять_минуты':600, 'Оставлять_Гб':20, 'День_обновления_остатков':12, 'Абонплата':125, 'Описание':' 35 ГБ, 600 минут', 'Подписаться':True, 'ЛС': '9011720400', "Поддерживать_Гб":1},
      # '9011720401':{'Активная_симка':False, 'Name':'Надежда мама', 'Оставлять_минуты':700, 'Оставлять_Гб':5, 'День_обновления_остатков':21, 'Абонплата':125, 'Описание':' 35 ГБ, 600 минут', 'Подписаться':True, 'ЛС': '9011720400'},
      #
      '9005034564': {'Активная_симка': True, 'Name': 'Евгения', 'Оставлять_минуты': 200, 'Оставлять_Гб': 25, 'День_обновления_остатков': 9, 'Абонплата': 337.5, 'Описание': 'Вологда  35 ГБ, 600 минут', 'ЛС': ''},
      #
      ...
      #
      '9005491033':{'Активная_симка':True, 'Name':'Орлов Стекольный', 'Оставлять_минуты':0, 'Оставлять_Гб':3, 'День_обновления_остатков':19, 'Абонплата':300, 'Описание':'Вологда 15 ГБ, 350 минут', 'ЛС': '9005072994'},
      '9005507677':{'Активная_симка':True, 'Name':'Орлов Лакомка', 'Оставлять_минуты':0, 'Оставлять_Гб':3, 'День_обновления_остатков':25, 'Абонплата':300, 'Описание':'Вологда 25ГБ, 350 минут', 'ЛС': '9005072994'},
      '9535208906':{'Активная_симка':True, 'Name':'Орлов Универмаг', 'Оставлять_минуты':0, 'Оставлять_Гб':3, 'День_обновления_остатков':25, 'Абонплата':500, 'Описание':'Вологда 25ГБ, 600 минут +', 'ЛС': '9005072994'},
      '9005072994':{'Активная_симка':False, 'Name':'Орлов Личный', 'Оставлять_минуты':200, 'Оставлять_Гб':1, 'День_обновления_остатков':1, 'Абонплата':0, 'Описание':'Вологда Классический v. 1.4', 'ЛС': '9005072994'}
...
while True:
    ...
    for ЛС in Список_ЛС.keys():
        ...
        for Current_phone in var["Телефоны"][ЛС]['ПочиненныеНомера']:
            ПродаватьС = min(ПродаватьС, var["Телефоны"][Current_phone].get('ПродаватьС', ''))
    ...
    if ВсегоНомеровСПродажей==0 and ПродаватьС > str(datetime.datetime.now())[:10]:
